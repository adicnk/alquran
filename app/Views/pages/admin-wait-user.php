                        ...
                        <div class="card-text text-center">
                            <div class="row">
                                ...
                                <div class="col-6 text-center text-success">
                                    <h2>Manage User dalam Jadwal Ujian</h2>
                                    <hr class="garis1">
                            ...
                            <div class="row text-left">
                                <?php foreach ($event as $ev) : ?>
                                    <div class="d-flex flex-row mt-3">
                                        <div class="p-2">
                                            <input class="mr-2" id="auto-user" type="checkbox" onclick="Javascript:location.href='/jadwal/wait'">Semua mahasiswa ikut secara otomatis dalam ujian
                                        </div>
                                    </div>
                                <?php endforeach ?>
                            </div>
