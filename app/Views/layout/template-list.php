...
<body class="sb-nav-fixed" onload="defaultType()">
    ...
    <script>
        ...
        function changeType() {
            var ujian = document.getElementById("filter-kategori").value
            var x = document.getElementById("divsubject");
            ...
            if (x.style.display = 'block') {
                clearSubject();
                document.getElementById("filter-subjects").value = null;
        ...
        function setSubject() {
            var subject = document.getElementById('filter-subjects');
            ...
            ?>
                $("#filter-subjects").append(new Option("<?= $sb['name'] ?>", "<?= $sb['id'] ?>"));
            <?php endforeach ?>
        }
