                ...
                <div class="card o-hidden border-0 mt-3">
                    <div class="card-block mt-3">
                        <div class="card-text text-center">
                            ...
                            <form method="post" action="../submit/jadwal">
                                <?= csrf_field() ?>
                                ...
                                <div class="row mt-3">
                                    <div class="col-6 ">
                                        ...
                                        <div class="input-group nama">
                                            ...
                                            <input type="text" id="name" name="name" class="form-control ml-2 <?= ($validation->hasError('name') ? "is-invalid" : "") ?>" placeholder="masukkan nama lengkap" value="<?= old('name') ?>" onfocusin="yellowin(this);" onfocusout="whiteout(this)" autofocus>
                                ...
                                <div class="row mt-3">
                                    <div class="col-6">
                                        ...
                                        <div class="input-group date" data-provide="datepicker">
                                            ...
                                            <input type="text" id="date" name="date" class="form-control ml-2" onfocusin="yellowin(this);" onfocusout="whiteout(this)" onkeypress="return false">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <div class="input-group kategori">
                                            ...
                                            <input type="time" id="time" name="time" class="form-control ml-2 timepicker" onfocusin="yellowin(this);" onfocusout="whiteout(this)">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-6">
                                        ...
                                        <div class="input-group kategori">
                                            ...
                                            <input type="text" id="total" name="total" class="form-control ml-2 <?= ($validation->hasError('total') ? "is-invalid" : "") ?>" placeholder="masukkan jumlah soal yang akan disertakan dalam ujian" value="<?= old('total') ?>" onfocusin="yellowin(this);" onfocusout="whiteout(this)" onkeypress="return numOnly(event);">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="input-group durasi">
                                            ...
                                            <input type="text" id="durasi" name="durasi" class="form-control ml-2 <?= ($validation->hasError('durasi') ? "is-invalid" : "") ?>" placeholder="masukkan lama waktu ujian" value="<?= old('durasi') ?>" onfocusin="yellowin(this);" onfocusout="whiteout(this)" onkeypress="return numOnly(event);">
                                ...
                                <div class="row mt-3">
                                    <div class="col-6">
                                        ...
                                        <div class="input-group min-pass">
                                            ...
                                            <input type="text" id="min-pass" name="min-pass" class="form-control ml-2 <?= ($validation->hasError('min-pass') ? "is-invalid" : "") ?>" placeholder="masukkan nilai minimal kelulusan dalam ujian" value="<?= old('min-pass') ?>" onfocusin="yellowin(this);" onfocusout="whiteout(this)" onkeypress="return numOnly(event);">
                                ...
                                <div class="row mt-3">
                                    <div class="col-6">
                                        <div class="d-flex flex-row mt-3">
                                            <div class="p-2">
                                                <input class="mr-2" id="auto-user" name="auto-user" type="checkbox" checked>Semua mahasiswa aktif ikut secara otomatis dalam ujian
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="d-flex flex-row mt-3">
                                            <div class="p-2">
                                                <input class="mr-2" id="auto-content" name="auto-content" type="checkbox" checked>Semua soal aktif ikut secara otomatis di acak dalam ujian
                                            </div>
                                        </div>
                                    </div>
                                </div>
