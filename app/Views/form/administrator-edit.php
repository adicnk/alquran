                    ...
                    <div class="card-block mt-3">
                        <div class="card-text text-center">
                            ...
                            <?php foreach ($user as $usr) : ?>
                                <form method="post" action="../../update/administrator/<?= $usr['id'] ?>">
                                    <?= csrf_field() ?>
                                    <img class=" mb-4" src="/logo/logo.png" alt="" width="140" height="135">
                                    <h1 class="h3 mb-3 font-weight-bold text-white bg-primary">INPUT DATA ADMINISTRATOR</h1>
                                    <hr>
                                    <div class="row mt-3">
                                        <div class="col-6 ">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-6">
                                            ...
                                            <input type="text" id="nip" name="nip" class="form-control <?= ($validation->hasError('nip') ? "is-invalid" : "") ?>" placeholder="masukkan nomor induk administrator" value="<?= $usr['nip'] ?>" onfocusin="yellowin(this);" onfocusout="whiteout(this)" onkeypress="return numOnly(event);" disabled>
                                    ...
                                    <input type="hidden" id="niphidden" name="niphidden" value="<?= $usr['nip'] ?>">
